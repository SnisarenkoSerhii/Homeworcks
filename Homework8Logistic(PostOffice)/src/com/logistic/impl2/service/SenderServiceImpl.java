...
public class SenderServiceImpl implements SenderService {
    ...
    private Transit reverseTransit(Transit transit) {
        ...
        Transit result = new com.logistic.impl2.model.transport.Transit(reversedOffices, transit.getPrice());
        return result;
    }
    ...
    @Override
    public boolean sendPackage(com.logistic.api.model.post.Package parcel, Transit transit) {
        ...
        for(PostOffice office : transit.getTransitOffices()) {
            ...
            getMilesToDestination(parcel.getPackageId());
            parcel.setMilesToDestination(getMilesToDestination(parcel.getPackageId()));
            if(hasBeenLost()) {
